...
public class MyPanel extends JPanel implements ActionListener{
	...
	final int PANEL_WIDTH = 400; //setting the panel width to 500
	final int PANEL_HEIGHT = 300; //setting the panel height to 500
	...
	MyPanel(){
		...
		//this.setBackground(Color.white); //set the backround colour to black
